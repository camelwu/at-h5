...
var VueLazyload = {
  install: function (Vue, Options) {
    ...
    var onListen = function onListen(start, parentEl) {
      if (start) {
        _.on(parentEl, 'scroll', lazyLoadHandler);
        _.on(parentEl, 'wheel', lazyLoadHandler);
        _.on(parentEl, 'mousewheel', lazyLoadHandler);
        _.on(parentEl, 'resize', lazyLoadHandler);
        _.on(parentEl, 'animationend', lazyLoadHandler);
        _.on(parentEl, 'transitionend', lazyLoadHandler);
      } else {
        Init.hasbind = false;
        _.off(parentEl, 'scroll', lazyLoadHandler);
        _.off(parentEl, 'wheel', lazyLoadHandler);
        _.off(parentEl, 'mousewheel', lazyLoadHandler);
        _.off(parentEl, 'resize', lazyLoadHandler);
        _.off(parentEl, 'animationend', lazyLoadHandler);
        _.off(parentEl, 'transitionend', lazyLoadHandler);
      }
    };
