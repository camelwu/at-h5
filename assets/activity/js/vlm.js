...
(function (e, t) {
  var n = n || (function (n) { //123.56.190.34:8888 //10.6.11.20:8888 10.7.2.111  10.7.2.119 m.yazhoulvyou.cn
      ...
      arr_t = {
      ...
      }, loadJsonActivity = function (ajaxOptions, data, successCallback, failCallback, completeCallback, async, encryption) {
        ...
        ;
        var apiUrl = ajaxOptions.url == "" ? _api : ajaxOptions.url;
        $.ajax({
          ...
          success: function (data) {
            if (data.success) {
              ...
              failCallback && failCallback(null, null, data.message);
            }
          },
          error: function (XMLHttpRequest, textStatus) {
            ...
            failCallback && failCallback(XMLHttpRequest, textStatus);
          },
          complete: function () {
      ...
      return {
        ...
        l_contact: l_contact,
        loadJson: loadJson,
        loadJsonActivity: loadJsonActivity,
        loadJsonp: loadJsonp,
...
(function () {
  ...
  hm.src = "//hm.baidu.com/hm.js?b48548bbad5d8d71003403eae1a2ccc8";
