...
var roomUpGrade = {
	...
	callBack : function() {
        ...
        Avgrating = resultData.data.hotels[0].hotelGenInfo.hotelReviewScore;
        TAReviewCount = resultData.data.hotels[0].hotelGenInfo.hotelReviewCount;
        window.localStorage.hotelDetailData = JSON.stringify(resultData);
				...
				$('#map, li.map_address').on('click',function(){
					window.location.href = 'hotel_detail_map.html?HotelName='+dataMap.hotelNameLocale+'('+dataMap.hotelName+') '+dataMap.hotelAddress+'&Latitude='+latitude+'&Longitude='+longitude;
				});
