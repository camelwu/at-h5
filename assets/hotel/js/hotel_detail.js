	...
	var hotelDetail = {
      ...
      if (hotelGenInfo.isFreeCityTour) {
        isFreeCityTour = '<div class="h-div1">免费景点</div>';
			...
			secondUl += '<ul class="d-ul2 hotel_content">' + '<li id="chooseDate"><span class="enterDate">' + hotelDetail.gdataInfo.CheckInDate + '</span>&nbsp入住<span class="enterDate" style="margin-left: 5px;">' + hotelDetail.gdataInfo.CheckOutDate + '</span>&nbsp离店 &nbsp <em>共<span id="nightNum" class = "time_span">' + hotelDetail.sTools.getTotalNights(hotelDetail.gdataInfo.CheckOutDate, hotelDetail.gdataInfo.CheckInDate) + '</span>晚</em><b class="icons open-arg1 hotel_shoulder_icon"></b><div class = ""><span>'+hotelDetail.gdataInfo.NumRoom+'</span>房间<span>'+hotelDetail.gdataInfo.NumAdult+'</span>成人<span>'+hotelDetail.gdataInfo.NumChild+'</span>儿童</div></li>' + hotelDetail.showRoomList(result) + '</ul>';
