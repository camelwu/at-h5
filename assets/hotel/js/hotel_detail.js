...
(function (window, document) {
  var hotelDetail = {
    ...
    subRoomListNoService: function (arg) {
      ...
      var canceAble = '<span class="no-cancel">' + arg.cancellationInfoInRoomList + '</span>';
    ...
    createAll: function (result) {
      ...
      if (hotelDetail.showRoomList(result) == '') {
        //房间已售罄
        secondUl += '<div class="hotel_content_wrap">' + '<div class="check_inout_msg"  id="chooseDate"><span class="enterDate">' + vlm.Utils.format_date(hotelDetail.gdataInfo.CheckInDate, "md") + '</span><b class="hotel_pad">入住</b><span class="enterDate" >' + vlm.Utils.format_date(hotelDetail.gdataInfo.CheckOutDate, "md") + '</span><b class="hotel_pad">离店</b><em>共 <span id="nightNum" class = "time_span">' + vlm.Utils.compareDay(hotelDetail.gdataInfo.CheckInDate, hotelDetail.gdataInfo.CheckOutDate) + '</span> 晚</em><b class="icons open-arg1 hotel_shoulder_icon"></b></div><div class = "hotel_content_num check_inout_msg" id="js_hotel_content_num"><span id="js_hot_det_roomnum">' + hotelDetail.gdataInfo.NumRoom + '</span><b class="hot_room_pad">间房</b><span id="js_hot_det_adultnum">' + hotelDetail.gdataInfo.NumAdult + '</span><b class="hot_room_pad">成人</b><span id="js_hot_det_childnum">' + hotelDetail.gdataInfo.NumChild + '</span><b class="hot_room_pad">儿童</b><b class="icons open-arg1 hotel_shoulder_icon"></b></div><ul class="showRoom"></ul>' + '<div class="room_soldout">房间已售完，您可以选择其他酒店或者修改入离日期和入住人数重新查询。</div>' + '</div>';
      } else {
