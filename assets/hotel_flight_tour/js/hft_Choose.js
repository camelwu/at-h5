  ...
  testLogin: function () {
   /* if (vlm.checkLogin('hftChoose.testLogin')) {*/
      ...
      that.timer0 = setTimeout(function () {
        ...
        that.timer0 = null;
        window.location.href = that.type == 2 ? "../hotel_flight_tour/hft_order.html?type=" + that.type + "&packageId=" + that.initParaObj.packageID : "../hotel_flight_tour/hf_order.html?type=" + that.type;
      }, 500);
  /*  }*/
  },
