            ...
            for (var i = 0; i < data.flightInfoListGroup.length; i++) {
              for (var j = 0; j < data.flightInfoListGroup[i].flightInfoList.length; j++) {
                if (data.flightInfoListGroup[i].flightInfoList[j].setID == setid) {
                  ...
                  hftFlightHotelTourInfo.flightSetID = data.flightInfoListGroup[i].flightInfoList[j].setID;
                  hftFlightHotelTourInfo.flightCacheID = data.flightInfoListGroup[i].flightInfoList[j].cacheID;
                }
              }
            }
