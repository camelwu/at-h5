...
var htf_search = {
    ...
    init_title_room: function () {
        ...
        if (localStorage.cacheSearch) {
            ...
            for (var i = 0; i < cacheSearch.hfSearchInfo.RoomInfo.length; i++) {
                if (i == 0) {
                    if (cacheSearch.hfSearchInfo.RoomInfo[i].childWithOutBed && cacheSearch.hfSearchInfo.RoomInfo[i].adult == 1) {
                        initStr_hf = '<span class="title">房间1</span>' + '<div class="numbList">' + '<span class="n_tit">成人</span>' + '<div class="per_price_control" data-type="adult"><span class="cut_down_btn" id="adultDown"></span><i class="cut_up_cont adult_people_number" data-type="adultNum" id="adult_people_number">' + cacheSearch.hfSearchInfo.RoomInfo[i].adult + '</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="numbList">' + '<span class="n_tit">儿童</span>' + '<span class="child_age">(2-12岁)</span>' + '<b class="com_icon child_age_state"></b>' + '<div class="age_state_box"><div class="state_text">儿童年龄限制为大于等于2周岁，小于12周岁的儿童。</div><div></div></div>' + '<div class="per_price_control" data-type="extraChild"><span class="cut_down_btn"></span><i class="cut_up_cont child_number" data-type="childNum">2</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="extraChild">' + '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="(2-12)" value="' + cacheSearch.hfSearchInfo.RoomInfo[i].childWithBed[0] + '" onkeyup="setAge(this);" onblur="checkAge(this);"><i class="child_sui">岁</i>' + '</div>' + '<span class="bedList" style="float: left"><i>儿童2年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" value="' + cacheSearch.hfSearchInfo.RoomInfo[i].childWithOutBed[0] + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '</div>';
                    } else if (cacheSearch.hfSearchInfo.RoomInfo[i].childWithOutBed && cacheSearch.hfSearchInfo.EchChildNum[i] == 1) {
                        initStr_hf = '<span class="title">房间1</span>' + '<div class="numbList">' + '<span class="n_tit">成人</span>' + '<div class="per_price_control" data-type="adult"><span class="cut_down_btn" id="adultDown"></span><i class="cut_up_cont adult_people_number" data-type="adultNum" id="adult_people_number">' + cacheSearch.hfSearchInfo.RoomInfo[i].adult + '</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="numbList">' + '<span class="n_tit">儿童</span>' + '<span class="child_age">(2-12岁)</span>' + '<b class="com_icon child_age_state"></b>' + '<div class="age_state_box"><div class="state_text">儿童年龄限制为大于等于2周岁，小于12周岁的儿童。</div><div></div></div>' + '<div class="per_price_control" data-type="extraChild"><span class="cut_down_btn"></span><i class="cut_up_cont child_number" data-type="childNum">1</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="extraChild">' + '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="(2-12)" value="' + cacheSearch.hfSearchInfo.RoomInfo[i].childWithOutBed[0] + '" onkeyup="setAge(this);" onblur="checkAge(this);"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList spenumbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon noselect"></b></span>' + '</div>' + '</div>';
                    } else if (cacheSearch.hfSearchInfo.RoomInfo[i].childWithOutBed && cacheSearch.hfSearchInfo.EchChildNum[i] == 2) {
                        initStr_hf = '<span class="title">房间1</span>' + '<div class="numbList">' + '<span class="n_tit">成人</span>' + '<div class="per_price_control" data-type="adult"><span class="cut_down_btn" id="adultDown"></span><i class="cut_up_cont adult_people_number" data-type="adultNum" id="adult_people_number">' + cacheSearch.hfSearchInfo.RoomInfo[i].adult + '</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="numbList">' + '<span class="n_tit">儿童</span>' + '<span class="child_age">(2-12岁)</span>' + '<b class="com_icon child_age_state"></b>' + '<div class="age_state_box"><div class="state_text">儿童年龄限制为大于等于2周岁，小于12周岁的儿童。</div><div></div></div>' + '<div class="per_price_control" data-type="extraChild"><span class="cut_down_btn"></span><i class="cut_up_cont child_number" data-type="childNum">2</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="extraChild">' + '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="(2-12)" value="' + cacheSearch.hfSearchInfo.RoomInfo[i].childWithBed[0] + '" onkeyup="setAge(this);" onblur="checkAge(this);"><i class="child_sui">岁</i>' + '</div>' + '<span class="bedList" style="float: left"><i>儿童2年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" value="' + cacheSearch.hfSearchInfo.RoomInfo[i].childWithOutBed[0] + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList spenumbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon ico_select"></b></span>' + '</div>' + '</div>';
                    } else if (cacheSearch.hfSearchInfo.RoomInfo[i].childWithBed && cacheSearch.hfSearchInfo.EchChildNum[i].adult == 1) {
                        initStr_hf = '<span class="title">房间1</span>' + '<div class="numbList">' + '<span class="n_tit">成人</span>' + '<div class="per_price_control" data-type="adult"><span class="cut_down_btn" id="adultDown"></span><i class="cut_up_cont adult_people_number" data-type="adultNum" id="adult_people_number">' + cacheSearch.hfSearchInfo.RoomInfo[i].adult + '</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="numbList">' + '<span class="n_tit">儿童</span>' + '<span class="child_age">(2-12岁)</span>' + '<b class="com_icon child_age_state"></b>' + '<div class="age_state_box"><div class="state_text">儿童年龄限制为大于等于2周岁，小于12周岁的儿童。</div><div></div></div>' + '<div class="per_price_control" data-type="extraChild"><span class="cut_down_btn"></span><i class="cut_up_cont child_number" data-type="childNum">1</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="extraChild">' + '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="(2-12)" value="' + cacheSearch.hfSearchInfo.RoomInfo[i].childWithBed[0] + '" onkeyup="setAge(this);" onblur="checkAge(this);"><i class="child_sui">岁</i>' + '</div>' + '</div>';
                    } else if (cacheSearch.hfSearchInfo.RoomInfo[i].childWithBed && cacheSearch.hfSearchInfo.EchChildNum[i] == 1) {
                        initStr_hf = '<span class="title">房间1</span>' + '<div class="numbList">' + '<span class="n_tit">成人</span>' + '<div class="per_price_control" data-type="adult"><span class="cut_down_btn" id="adultDown"></span><i class="cut_up_cont adult_people_number" data-type="adultNum" id="adult_people_number">' + cacheSearch.hfSearchInfo.RoomInfo[i].adult + '</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="numbList">' + '<span class="n_tit">儿童</span>' + '<span class="child_age">(2-12岁)</span>' + '<b class="com_icon child_age_state"></b>' + '<div class="age_state_box"><div class="state_text">儿童年龄限制为大于等于2周岁，小于12周岁的儿童。</div><div></div></div>' + '<div class="per_price_control" data-type="extraChild"><span class="cut_down_btn"></span><i class="cut_up_cont child_number" data-type="childNum">1</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="extraChild">' + '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="(2-12)" value="' + cacheSearch.hfSearchInfo.RoomInfo[i].childWithBed[0] + '" onkeyup="setAge(this);" onblur="checkAge(this);"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList spenumbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon noselect ico_select"></b></span>' + '</div>' + '</div>';
                    } else {
            ...
            for (var j = 0; j < cacheSearch.hftSearchInfo.RoomInfo.length; j++) {
                if (j == 0) {
                    if (cacheSearch.hftSearchInfo.RoomInfo[j].childWithOutBed && cacheSearch.hftSearchInfo.RoomInfo[j].adult == 1) {
                        initStr_hft = '<span class="title">房间1</span>' + '<div class="numbList">' + '<span class="n_tit">成人</span>' + '<div class="per_price_control" data-type="adult"><span class="cut_down_btn" id="adultDown"></span><i class="cut_up_cont adult_people_number" data-type="adultNum" id="adult_people_number">' + cacheSearch.hftSearchInfo.RoomInfo[j].adult + '</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="numbList">' + '<span class="n_tit">儿童</span>' + '<span class="child_age">(2-12岁)</span>' + '<b class="com_icon child_age_state"></b>' + '<div class="age_state_box"><div class="state_text">儿童年龄限制为大于等于2周岁，小于12周岁的儿童。</div><div></div></div>' + '<div class="per_price_control" data-type="extraChild"><span class="cut_down_btn"></span><i class="cut_up_cont child_number" data-type="childNum">2</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="extraChild">' + '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="(2-12)" value="' + cacheSearch.hftSearchInfo.RoomInfo[j].childWithBed[0] + '" onkeyup="setAge(this);" onblur="checkAge(this);"><i class="child_sui">岁</i>' + '</div>' + '<span class="bedList" style="float: left"><i>儿童2年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" value="' + cacheSearch.hftSearchInfo.RoomInfo[j].childWithOutBed[0] + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '</div>';
                    } else if (cacheSearch.hftSearchInfo.RoomInfo[j].childWithOutBed && cacheSearch.hftSearchInfo.EchChildNum[j] == 1) {
                        initStr_hft = '<span class="title">房间1</span>' + '<div class="numbList">' + '<span class="n_tit">成人</span>' + '<div class="per_price_control" data-type="adult"><span class="cut_down_btn" id="adultDown"></span><i class="cut_up_cont adult_people_number" data-type="adultNum" id="adult_people_number">' + cacheSearch.hftSearchInfo.RoomInfo[j].adult + '</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="numbList">' + '<span class="n_tit">儿童</span>' + '<span class="child_age">(2-12岁)</span>' + '<b class="com_icon child_age_state"></b>' + '<div class="age_state_box"><div class="state_text">儿童年龄限制为大于等于2周岁，小于12周岁的儿童。</div><div></div></div>' + '<div class="per_price_control" data-type="extraChild"><span class="cut_down_btn"></span><i class="cut_up_cont child_number" data-type="childNum">1</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="extraChild">' + '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="(2-12)" value="' + cacheSearch.hftSearchInfo.RoomInfo[j].childWithOutBed[0] + '" onkeyup="setAge(this);" onblur="checkAge(this);"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList spenumbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon noselect"></b></span>' + '</div>' + '</div>';
                        ...
                        initStr_hft = '<span class="title">房间1</span>' + '<div class="numbList">' + '<span class="n_tit">成人</span>' + '<div class="per_price_control" data-type="adult"><span class="cut_down_btn" id="adultDown"></span><i class="cut_up_cont adult_people_number" data-type="adultNum" id="adult_people_number">' + cacheSearch.hftSearchInfo.RoomInfo[j].adult + '</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="numbList">' + '<span class="n_tit">儿童</span>' + '<span class="child_age">(2-12岁)</span>' + '<b class="com_icon child_age_state"></b>' + '<div class="age_state_box"><div class="state_text">儿童年龄限制为大于等于2周岁，小于12周岁的儿童。</div><div></div></div>' + '<div class="per_price_control" data-type="extraChild"><span class="cut_down_btn"></span><i class="cut_up_cont child_number" data-type="childNum">1</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="extraChild">' + '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="(2-12)" value="' + cacheSearch.hftSearchInfo.RoomInfo[j].childWithBed[0] + '" onkeyup="setAge(this);" onblur="checkAge(this);"><i class="child_sui">岁</i>' + '</div>' + '</div>';
            ...
            $('#hf_roomNum').html(1);
            $('#hft_roomNum').html(1);
            initStr_hf = '<span class="title">房间1</span>' + '<div class="numbList">' + '<span class="n_tit">成人</span>' + '<div class="per_price_control" data-type="adult"><span class="cut_down_btn" id="adultDown"></span><i class="cut_up_cont adult_people_number" data-type="adultNum" id="adult_people_number">2</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="numbList">' + '<span class="n_tit">儿童</span>' + '<span class="child_age">(2-12岁)</span>' + '<b class="com_icon child_age_state"></b>' + '<div class="age_state_box"><div class="state_text">儿童年龄限制为大于等于2周岁，小于12周岁的儿童。</div><div></div></div>' + '<div class="per_price_control" data-type="extraChild"><span class="cut_down_btn"></span><i class="cut_up_cont child_number" data-type="childNum">0</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="extraChild" style="display: none">' + '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="(2-12)" onkeyup="setAge(this);" onblur="checkAge(this);"><i class="child_sui">岁</i>' + '</div>';
            section = document.createElement('section');
            section.innerHTML = initStr_hf;
    ...
    initCalendar: function () {
        ...
        //显示出发日期
        var fhEndDay = $("#fhCalendar .js_endDay");
        //显示返程日期
        var fhStartDayData = $("#fhCalendar .js_startData");
        //保存出发日期
        var fhReturnDayData = $("#fhCalendar .js_returnData");
        //保存返程日期
        var fhStartWeekDay = $("#fhCalendar .week_one");
        var fhEndWeekDay = $("#fhCalendar .week_two");
        //F+H+T
        var fhtStartDay = $("#fhtCalendar .js_startDay");
        //显示出发日期
        var fhtEndDay = $("#fhtCalendar .js_endDay");
        //显示返程日期
        var fhtStartDayData = $("#fhtCalendar .js_startData");
        //保存出发日期
        var fhtReturnDayData = $("#fhtCalendar .js_returnData");
        //保存返程日期
    ...
    changeChildTemp: function (box, n, i) {
        ...
        if (age1 != '') {
            if (n == 1) {
                ...
                listStr.innerHTML = '<span class="bedList" style="float: left"><i>儿童' + i + '年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" value = "' + age1 + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList spenumbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon noselect"></b></span>' + '</div>';
            } else if (i == 2) {
                age2 = listStr.getElementsByClassName('inp_cage')[1].value;
                if (age2 != '') {
                    listStr.innerHTML = '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" value = "' + age1 + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<span class="bedList" style="float: left"><i>儿童2年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" value = "' + age2 + '" onkeyup="setAge(this);"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList spenumbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon noselect ico_select"></b></span>' + '</div>';
                } else {
                    listStr.innerHTML = '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" value = "' + age1 + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<span class="bedList" style="float: left"><i>儿童2年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="' + 2 + '-' + 12 + '" onkeyup="setAge(this);"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList spenumbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon noselect ico_select"></b></span>' + '</div>';
                }
            }
        } else {
            if (n == 1) {
                ...
                listStr.innerHTML = '<span class="bedList" style="float: left"><i>儿童' + i + '年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="' + 2 + '-' + 12 + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList spenumbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon noselect"></b></span>' + '</div>';
            } else if (i == 2) {
                listStr.innerHTML = '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="' + 2 + '-' + 12 + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<span class="bedList" style="float: left"><i>儿童2年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="' + 2 + '-' + 12 + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList spenumbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon noselect ico_select"></b></span>' + '</div>';
            }
        }
        this.addbed();
    },
    ...
    addbed: function () {
        ...
        //var addBedHTML1 = addNum[1].innerHTML;
        for (var j = 0; j < addBed.length; j++) {
            {
                (function (index) {
                    if (addBedHTML < 2) {
                        ...
                        addNum.className = 'com_icon noselect ico_select ico_force';
                    }
                }(j));
            }
        }
    ...
    extraChildTemp: function (i, n, box) {
        ...
        if (age != '') {
            if (n == 1) {
                ...
                return '<span class="bedList" style="float: left"><i>儿童' + i + '年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" value = "' + age + '"" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList spenumbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon noselect"></b></span>' + '</div>';
            } else if (i == 2) {
                return '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" value = "' + age + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<span class="bedList" style="float: left"><i>儿童2年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="' + 2 + '-' + 12 + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList spenumbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon noselect ico_select"></b></span>' + '</div>';
            }
        } else {
            if (n == 1) {
                if (i == 2) {
                ...
                return '<span class="bedList" style="float: left"><i>儿童' + i + '年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="' + 2 + '-' + 12 + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList spenumbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon noselect"></b></span>' + '</div>';
            } else if (i == 2) {
                return '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="' + 2 + '-' + 12 + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<span class="bedList" style="float: left"><i>儿童2年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" placeholder="' + 2 + '-' + 12 + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList spenumbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon noselect ico_select"></b></span>' + '</div>';
            }
        }
        this.addbed();
    },
    ...
    extraRoomTemp: function (i) {
        return '<span class="title">房间' + i + '</span>' + '<div class="numbList">' + '<span class="n_tit">成人</span>' + '<div class="per_price_control" data-type="adult"><span class="cut_down_btn" id="adultDown"></span><i class="cut_up_cont adult_people_number" data-type="adultNum" id="adult_people_number">2</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="numbList">' + '<span class="n_tit">儿童</span>' + '<span class="child_age">(' + 2 + '-' + 12 + '岁)</span>' + '<div class="per_price_control" data-type="extraChild"><span class="cut_down_btn"></span><i class="cut_up_cont child_number" data-type="childNum">0</i><span class="plus_btn"></span></div>' + '</div>' + '<div class="extraChild" style="display: none">' + '<span class="bedList" style="float: left"><i>儿童1年龄</i></span>' + '<div class="childAge">' + '<input class="inp_cage" type="tel" value placeholder="' + 2 + '-' + 12 + '" onkeyup="setAge(this);" onblur="checkAge(this)"><i class="child_sui">岁</i>' + '</div>' + '<div class="numbList">' + '<span class="bedList" data-type="ifaddBed"><i>加一张床</i><b class="com_icon noselect"></b></span>' + '</div>' + '</div>';
    },
    ...
    next_page: function () {
        ...
        for (var m = 0; m < hf_room.length; m++) {
            ...
            if (hf_temAdultNum == 1 && hf_temChildNum == 1) {
                hf_childWithBed.push(hf_room[m].querySelector('input').value);
        ...
        for (var n = 0; n < hft_room.length; n++) {
            ...
            if (hft_temAdultNum == 1 && hft_temChildNum == 1) {
                hft_childWithBed.push(hft_room[n].querySelector('input').value);
