(function(){
  ...
  var ulrRoomId = parseInt(chooseUrl.substring(15));
  ...
  function ulList(data){
    ...
    //添加当前选中
    $('.hotel_detail_rooms li').each(function(i){
      //if(ulrRoomId == data.hotelInfo.rooms[i].roomID){
      //  $('.hotel_detail_rooms li').eq(i).addClass('cur');
      //}
    })
    //点击事件  跳转
