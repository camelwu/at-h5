...
for(var i = 0;i < internationalCities.length; i++){
    for(var tem in internationalCitiesData){
        if(internationalCities[i].pingYin.charAt(0) == tem){
            internationalCitiesData[tem].push(internationalCities[i])
        }
    }
}
delete internationalCitiesData[0];
for(var temv in internationalCitiesData){
    if(internationalCitiesData[temv].length==0){
        delete internationalCitiesData[temv];
    }
}
for(var j = 0;j < domesticCities.length; j++){
    for(var temb in domesticCitiesData){
        if(domesticCities[j].pingYin.charAt(0) == temb){
            domesticCitiesData[temb].push(domesticCities[j])
        }
    }
}
