                    ...
                    for(var name in dataWorIN){
                        if(citySearchBox.value){
                            for(var j=0;j<dataWorIN[name].length;j++){
                                if(citySearchBox.value==dataWorIN[name][j].cityNameCN.substring(0,(citySearchBox.value.length))||citySearchBox.value==dataWorIN[name][j].pingYin.substring(0,(citySearchBox.value.length))||citySearchBox.value==dataWorIN[name][j].cityNameEN.substring(0,(citySearchBox.value.length))){
                    ...
                    for(var name in dataWorCN){
                        if(dcitySearchBox.value){
                            ...
                            for(var j=0;j<dataWorCN[name].length;j++){
                                if(dcitySearchBox.value==dataWorCN[name][j].cityNameCN.substring(0,(dcitySearchBox.value.length))||dcitySearchBox.value==dataWorCN[name][j].pingYin.substring(0,(dcitySearchBox.value.length))||dcitySearchBox.value==dataWorCN[name][j].cityNameEN.substring(0,(dcitySearchBox.value.length))){
