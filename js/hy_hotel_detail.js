    ...
    var hotelDetail ={
        ...
        createAll:function(result){
            ...
            if(result.Success==true){
                document.body.removeChild(hotelDetail.$Id('preloader'));
            ...
            var allStr = '',headerStr='',frontImgStr='',imgContainer='',firstUl='',secondUl='',contentStr='';

            hotelDetail.sourceData=result;

            headerStr+='<div class="header detailHeader" id="vlm-h-1"><a href="javascript:window.history.back(-1);" class="icons header-back"></a><h3>'+hotelDetail.sTools.hotelName(result.Data[0].HotelGenInfo.HotelName)+'</h3></div>';
            ...
            imgContainer+='<div id="imageContainer"><h5 class="indexShow"></h5><div class="showZone">' +
            '<ul class="imgUl" style="left: 0px; width: 1400%;">'+hotelDetail.sTools.getImages(result.Data[0].HotelImagesList)+'</ul></div></div>';
            ...
            contentStr+='<div id="content" class="snap-content" style="padding-top: 45px;">'+frontImgStr+imgContainer+firstUl+secondUl+'</div>';

            allStr+=headerStr+contentStr;

            hotelDetail.$CN('all-elements')[0].innerHTML=allStr;

            hotelDetail.imageHandler(result)     //处理图片
        ...
        toggleRoomModals:function(gInfo){
            ...
            hotelDetail.jAjax("http://10.2.22.239:8888/api/GetServiceApiResult",roomInfo,"0010",3,hotelDetail.showRoomModals);
        },
        ...
        init:function(){
            ...
            this.jAjax("http://10.2.22.239:8888/api/GetServiceApiResult",dataObj,"0008",3,this.createAll);
