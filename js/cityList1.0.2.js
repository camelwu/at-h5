...
myCityList.prototype={
    ...
    container:function(){
        var str= '<div class="cl_box">'+
            ...
            '                <a href="user-infolist.html" class="icons header-back"></a>'+
            '                <div class="cl_search">'+
        ...
        oDiv.innerHTML=str;
        lsf_myweb.setStyle(oDiv,{"position":"absolute","overflowX":"hidden!important","width":"100%","height":"100%","min-height":"100%","max-height":"100%","left":0,"top":0});
        ...
        lsf_myweb.bind(hotUl,'click',function(ev){
            ...
            if(oSrc.tagName=='LI'){
                for(var i=0;i<hotUl.children.length;i++){
                    hotUl.children[i].style.color='rgb(27,27,27)';
                }
